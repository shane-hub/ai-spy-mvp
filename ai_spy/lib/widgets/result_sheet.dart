...
class ResultSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String title = isDanger ? "🚨 FAKE ALERT!" : "✅ 100% ORGANIC";
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (isDanger) // Only show confidence on AI detection usually to build trust
                Text(
                  "Guabao's Confidence: $scanPercent",
              ...
              TextButton(
                onPressed: onClose,
                child: const Text("Scan Another Photo", style: TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: 16)),
              )
            ],
          ),
        ),
                  ...
                  child: SizedBox(
                    ...
                    child: AbsorbPointer(
                      child: ElevatedButton(
                        ...
                        child: const Text("Reveal Truth for ¥4.9", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                      ),
                    ),
                  ),
                )
            ...
            child: SizedBox(
              ...
              child: AbsorbPointer(
                child: ElevatedButton.icon(
                  ...
                  label: const Text("Share Verdict", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: themeColor,
                    foregroundColor: Colors.white,
                    elevation: 4,
